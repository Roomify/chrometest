...
Feature: Booking
  ...
  Scenario: Add bookings
    ...
    Then I select dates between "2016-10-01" and "2016-10-04" for the last unit
    And I wait 10 seconds
    ...
    And I wait 10 seconds
    Then I select dates between "2016-11-01" and "2016-11-04" for the last unit
    And I wait 10 seconds
    Then I press "Create booking"
    And I wait for AJAX to finish
    Then I press "Save Booking"
    ...
    And I fill in "booking_start_date_value[value][date]" with "2016-10-01"
    And I fill in "booking_end_date_value[value][date]" with "2016-10-21"
    And I fill in "name" with "My casa for bookings"
    Then I press "Apply"
    Then I should see "2016-10-01" in the "My casa for bookings" row
    And I should see "2016-10-03" in the "My casa for bookings" row

    Then I visit "admin/bat/bookings"
    And I fill in "booking_start_date_value[value][date]" with "2016-11-01"
    And I fill in "booking_end_date_value[value][date]" with "2016-11-21"
    Then I press "Apply"
    Then I should see "2016-11-01" in the "My casa2 for bookings" row
    And I should see "2016-11-03" in the "My casa2 for bookings" row
